...
phases = [
    {
        ...
        "learningObjectives": ["Understand variables, data types, and operators", "Master control flow with conditionals and loops", "Learn functions and basic I/O", "Develop logical thinking through pattern problems"],
        "topics": [
